...
def test_df_global_heatmap_4() -> None:
    ...
    path = (
        Path(__file__).parent.parent.parent
        / "examples/outputs/example_dark_4b_wallace_heatmap.svg"
    )
    print(path)
...
def test_df_global_heatmap_8() -> None:
    ...
    path = (
        Path(__file__).parent.parent.parent
        / "examples/outputs/example_dark_8b_wallace_heatmap.svg"
    )
    print(path)
...
def test_df_global_3d_heatmap_8() -> None:
    ...
    path = (
        Path(__file__).parent.parent.parent
        / "examples/outputs/example_dark_8b_wallace_3d_heatmap.svg"
    )
    print(path)
...
def test_df_global_3d_heatmap_4() -> None:
    ...
    path = (
        Path(__file__).parent.parent.parent
        / "examples/outputs/example_dark_4b_wallace_3d_heatmap.svg"
    )
    print(path)
